                                      ...
                                      <div class="text-md-right">
                                        <div class="float-lg-left mb-lg-0 mb-3">
                                            <?php if ($rowslide12->cartSTATUS ==3) {
                                             ?>
                                            <button class="btn btn-primary " data-toggle="modal" data-target="#Delivery">Borrow</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer text-center">
               <form method="post" action="query.php">
                ...
                <button type="submit" name="btndelivery" class="btn btn-success btn-lg  waves-effect">Borrow</button>
                </form>

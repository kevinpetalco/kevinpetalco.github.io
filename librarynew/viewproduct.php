                 ...
                 <div class="row">
                    ...
                    <div class="col-12 col-md-12 col-lg-5 p-0" ><!-- style="background-color: #bcd4ba;" -->
                        ...
                        <h5 style="margin-top:5px"><?php echo $rows->book_title;  ?></h5>
                                            ...
                                            <b>Book ID:</b> <?php echo $rows->book_callnumber;  ?><br>
                                            ...
                                            <!------ Include the above in your HEAD tag ---------->
                                              ...
                                              <div class="center" style="width:200px;">
                                                <p>
                                                      ...
                                                      <input type="text" name="quant" class="form-control input-number" value="1" min="1" max="<?php echo $rows->book_available;  ?>" style="border: solid 2px black;">
                                                      <span class="input-group-btn">

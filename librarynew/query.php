...
if(isset($_POST['btncomfirm2'])){ 
            ...
            if($delll)
            {
                echo"<script type='text/javascript'>window.location.replace('viewprofile.php');alert('Successfully Placed Borrowed Book Please Go To Librian To Get Your Book!')</script>";  
            }
}

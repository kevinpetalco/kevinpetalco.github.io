                                   ...
                                   <center>
                                    <div class="chocolat-parent">
                                        ...
                                        <a href="../img/product/<?php  if($row->book_image1==NULL){ ?>null.png<?php } else { echo $row->book_image1;?><?php } ?>" class="chocolat-image" title="Just an example">
                                            <div data-crop-image="">
                                                <img alt="image" src="../img/product/<?php echo $row->book_image1;  ?>" style="border:black solid  2px; width: 80%; height: auto;margin-top: 10px;" class="img-fluid" >
                                            </div>
                                        </a>
                                    ...
                                    <div class="col-6">
                                        <h5 style="margin-top: 20px"><?php echo $row->book_title;  ?></h5>
                                        <p>

                                             <b>Author:</b> <?php echo $row->book_author;  ?><br>
                                            <b>Publisher:</b> <?php echo $row->book_publisher;  ?><br>
                                            <b>Book ID:</b> <?php echo $row->book_callnumber;  ?><br>
                                            <b>Available Left:</b> <?php echo $row->book_available;  ?><br>
                                            <b>Borrowed Count:</b> <br>
                                            
                                            <b>Description:</b> <?php echo $row->book_abstract;  ?><br>
...
<h2 class="section-title">Update Book Image</h2>
                                	...
                                	<input type="files" accept="image/*" name="iamgedefault" value="<?php echo $row->book_image1;  ?>" hidden>
                                   <img alt="image" src="../img/product/<?php echo $row->book_image1;  ?>" style="border:black solid  2px; width: 80%; height: auto;margin-top: 10px;" class="img-fluid" >
                                   <hr>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" name="name" value="<?php echo $row->book_title;  ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Author</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" name="author" <?php echo $row->book_author;  ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Publisher</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" name="publisher" value="<?php echo $row->book_publisher;  ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Call Number</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" name="callnumber" value="<?php echo $row->book_callnumber;  ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" value="<?php echo $row->book_available;  ?>">Quantity</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" class="form-control" name="price" value="<?php echo $row->book_fines;  ?>">
                                        </div>
                                    </div>
...
<?php } ?>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea class="summernote-simple" style="border: solid 1px;" name="abstract"><?php echo $row->book_abstract;  ?></textarea>
                                        </div>
                                    </div>

...
if(isset($_POST['btnitemadds']))
        { 
            ...
            if($add)
            {
                echo"<script type='text/javascript'>window.location.replace('addnewproduct.php');alert('Successfully Added!')</script>";  
...
if(isset($_POST['btnacceptorder']))
{
            ...
            $notification = 'Your Book name'.$rowitem->book_title.'is Accepted by the'. $rowseller->sellername.'!';
...
if(isset($_POST['btnupdatesproducts']))
{
            ...
            if($add)
            {
                echo"<script type='text/javascript'>window.location.replace('viewproduct.php?itemid=$id');alert('You have succesfully update this book info!');</script>";  
...
if(isset($_POST['btnaddcategory']))
{
           ...
           if ($cate) {
              echo"<script type='text/javascript'>window.location.replace('category.php');alert('Successfully Added!');</script>";  
           }else{
             echo"<script type='text/javascript'>window.location.replace('category.php');alert('Error!');</script>";  
           }
...
if(isset($_POST['btnadddepartment']))
{
           ...
           if ($cate) {
              echo"<script type='text/javascript'>window.location.replace('dept.php');alert('Successfully Added!');</script>";  
           }else{
             echo"<script type='text/javascript'>window.location.replace('dept.php');alert('Error!');</script>";  
           }
...
if(isset($_POST['btnaddcourse']))
{
           ...
           if ($cate) {
              echo"<script type='text/javascript'>window.location.replace('course.php');alert('Successfully Added!');</script>";  
           }else{

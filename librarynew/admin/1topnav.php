...
<?php 
$chat=mysqli_query($con,"SELECT *  from chat GROUP BY accountID ")or die(mysqli_error($con));
              while($rowchat=mysqli_fetch_object($chat))
              {
                $student=mysqli_query($con,"SELECT * from account where accountID = '$rowchat->accountID'")or die(mysqli_error($con));
                $rowstudent=mysqli_fetch_object($student);
?>

                        <a href="messages.php?accountID=<?= $rowchat->accountID; ?>" class="dropdown-item dropdown-item-unread">
                            <div class="dropdown-item-icon bg-primary text-white">
                                <img alt="image" src="../img/user/<?= $rowstudent->image?>" style="width: 45px;height: 45; border: 1px solid black;border-radius: 50%;">
                            </div>
                            <div class="dropdown-item-desc"> <?= $rowstudent->name; ?>
                                <div class="time text-primary"><?= $rowchat->chatDES; ?></div>
                            </div>
                        </a>
<?php } ?>                        
                    </div>
                ...
                <li class="dropdown">
                    ...
                    <div class="d-sm-none d-lg-inline-block">Hi, <?= $rowseller->sellername;?></div></a>

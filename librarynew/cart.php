                                        ...
                                        <td>
                                               <a href="" class=""></a>
                                                ...
                                                <p><form method="post" action="query.php">
                                                      ...
                                                      <input type="text" name="quant" class="form-control input-number" value="<?php echo $rowlastestfeaturedslidecarttt->cartCOUNT;?>" min="1" max="10" style="border: solid 2px black;">
